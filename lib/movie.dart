class Movie {
  ...
  Movie(this.title, this.year, this.rated, this.released, this.runtime,
      this.genre, this.director, this.writer, this.actors, this.plot, this.language,
      this.country, this.awards, this.poster, this.metascore, this.imdbrating,
      this.imdbvotes, this.imdbID, this.type, this.response, this.images);
}